...
export const initialize = (methodSuffix) => (dispatch, getState) => {

    return fetch(apiConfig.resourceUri + '/Stage01' + methodSuffix, {
        method: 'GET',
        headers: {
            "Authorization": `Bearer ${getState().auth.accessToken}`,
            "Content-Type": 'application/json',
            "Ocp-Apim-Subscription-Key": "594381372f8f4c8194764a09030636cc"
        }
    }).then(response => {
