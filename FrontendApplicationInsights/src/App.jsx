...
// Below instrumentation key points to customer api, where alert has been configured
    return (
      <BrowserRouter>
        <TelemetryProvider instrumentationKey="fb64d0f6-3da4-4696-a310-6e12059cf652" after={() => { appInsights = getAppInsights() }}>
          <div >
            <Header />
